...
/// </summary>
[InvoiceProvider("0100727825", InvoiceProviderMatchKind.ProviderTaxCode, MayRequireUserIntervention = true)]
public sealed class FastInvoicePdfFetcher : IKeyedInvoicePdfFetcher
{
    ...
    {
        var keysearch = FastInvoiceKeysearchParsing.GetKeysearchFromPayload(payloadJson);
